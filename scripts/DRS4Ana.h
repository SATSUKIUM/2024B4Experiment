...
public:
    ...
    virtual void PlotdiscriCell_difference(Int_t iBoard1 = 0, Int_t iCh1 = 0, Int_t iBoard2 = 0, Int_t iCh2 = 2, Int_t entry_flag = 0, Double_t coef = 3.0, Int_t cut_flag = 0);
