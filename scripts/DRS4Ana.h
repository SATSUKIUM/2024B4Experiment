...
public:
    ...
    virtual Double_t PlotSumEnergy(TString key, TString key_Crystal1, Int_t iBoard1, Int_t iCh1, TString key_Crystal2, Int_t iBoard2, Int_t iCh2, Double_t Vcut, Double_t xmin, Double_t xmax);
